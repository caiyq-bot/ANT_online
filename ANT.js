...
function scheduleLoopLoopBegin(scheduleLoopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisScheduleLoop of scheduleLoop) {
...
function Fix_pracRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Fix_pracComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Cue_pracRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Cue_pracComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Target_pracRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Target_pracComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function AskPracRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of AskPracComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function QuitPracRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of QuitPracComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function BlockBeginRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of BlockBeginComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
